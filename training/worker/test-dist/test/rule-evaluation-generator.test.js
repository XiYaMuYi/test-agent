...
import { ruleBasedEvaluate, RuleBasedEvaluationReportGenerator, } from '../src/jobs/rule-evaluation-generator.js';
...
test('keyword hits increase dimension scores', () => {
    ...
    assert.ok(high.dimensionScores.needs_discovery > low.dimensionScores.needs_discovery, 'more keyword hits should raise needs_discovery');
