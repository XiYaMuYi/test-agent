 ...
 * 不会为任何令牌开放管理员权限。
 */
export class AdminBypassIdentityAdapter implements IdentityProviderPort {
  public constructor(
    private readonly adminTokens: ReadonlySet<string>,
    private readonly adminPrincipal: VerifiedPrincipal,
    private readonly inner: IdentityProviderPort,
  ) {}

  public async verifyAccessToken(token: string, context?: IdentityRequestContext): Promise<VerifiedPrincipal> {
