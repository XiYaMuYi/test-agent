import type { ErrorCode } from '@training/contracts';
 ...
 */
const USER_FACING_MESSAGE: Readonly<Record<ErrorCode, string>> = {
 ...
 */
export function getUserFacingMessage(code: string): string | undefined {
  return Object.prototype.hasOwnProperty.call(USER_FACING_MESSAGE, code)
    ? USER_FACING_MESSAGE[code as ErrorCode]
    : undefined;
}
