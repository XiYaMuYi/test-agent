...
export interface CoachFeedbackParams {
  userMsg: string;
  aiMsg: string;
  turnCount: number;
  customerMood: string;
 ...
 * - 最终 clamp 0-100
 */
export function ruleBasedCoachFeedback(params: CoachFeedbackParams): CoachFeedbackResult {
...
function buildImprovements(params: ImprovementParams): string[] {
  const {
    hasPlaceholder,
    hasProductDetail,
    turnCount,
