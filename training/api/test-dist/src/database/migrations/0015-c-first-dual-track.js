 ...
 */
export const cFirstDualTrackMigration = {
    id: '0015_c_first_dual_track',
    description: 'Add training_session/training_template/learner_profile and decouple conversation from the assigned-only chain for C-first free practice.',
    async up(database) {
