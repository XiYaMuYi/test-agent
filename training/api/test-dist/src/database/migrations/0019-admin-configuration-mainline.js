 ...
 */
export const adminConfigurationMainlineMigration = {
    id: '0019_admin_configuration_mainline',
    description: 'Add organization template revisions, C-end learner override policy columns, and persona_source support for scenario drafts (release-snapshot/v2 mainline).',
    async up(database) {
