 ...
 */
export const assignmentTaskOverrideMigration = {
    id: '0020_assignment_task_override',
    description: 'Add assignment.override_patch (task-level parameter override) and training_session.agent_config (frozen effective agent config per session).',
    async up(database) {
