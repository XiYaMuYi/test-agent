...
import { assessCustomerState, buildCustomerStatePrompt, moodLabelOf, parseCustomerStateAssessment, } from '../../../src/ai/coach/customer-state-assessor.js';
function previous() {
    return createInitialCustomerState(null);
}
function fullStateJson(overrides = {}) {
    const base = {
