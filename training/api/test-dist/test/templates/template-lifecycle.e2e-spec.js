...
async function createOrgTemplate(app, title) {
...
test('template maintenance validates input, is organization-isolated and admin-only', { timeout: 120_000 }, async (context) => {
    ...
    await db.query(`INSERT INTO training_template (id, organization_id, scope, owner_learner_id, title, persona_config)
     VALUES ($1, $2, 'platform', NULL, '官方模板', $3::jsonb)`, ['aaaaaaaa-0000-0000-0000-000000000001', PLATFORM_ORG, JSON.stringify(buildDefaultConfig())]);
