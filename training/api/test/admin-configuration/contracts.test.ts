...
import { diffTemplateRevisions, type OrganizationTemplateRevisionV1 } from '@training/contracts';
...
const REVISION_1: OrganizationTemplateRevisionV1 = {
  revisionId: 'r1',
  templateId: 't1',
  revision: 1,
  title: '初版',
...
test('loadReleaseSnapshotSchemaV2 requires the 13 frozen fields', () => {
  ...
  const required = schema.schema.required as readonly string[];
