...
import type { AgentRequest, AgentResponse, ModelProviderPort, PersonaConfig } from '@training/contracts';
...
function minimalPersona(): PersonaConfig {
  return {
    id: 'persona-1',
    name: '李阿姨',
    basedOnCard: 'card-1',
...
function minimalContext(persona: PersonaConfig | null) {
  return {
